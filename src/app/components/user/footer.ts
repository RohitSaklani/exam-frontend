...
@Component({
  selector: 'app-footer',
  imports: [],
  template: `<footer class="bg-(--secondary)">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 class="mb-6 text-sm font-semibold uppercase text-white dark:text-gray-300">
              Resources
            </h2>
            <ul class="text-body font-medium">
              <li class="mb-4">
                <a
                  ...
                  class="hover:underline text-white dark:text-gray-300"
                  >Flowbite</a
                >
              </li>
              <li>
          ...
          <div>
            <h2
              class="mb-6 text-sm font-semibold text-heading uppercase text-white dark:text-gray-300"
            >
              Follow us
            </h2>
            <ul class="text-body font-medium">
          ...
          <div>
            ...
            <ul class="text-body font-medium">
              <li class="mb-4">
                <a href="#" class="hover:underline text-white dark:text-gray-300">Privacy Policy</a>
              </li>
              <li>
                <a href="#" class="hover:underline text-white dark:text-gray-300"
                  >Terms &amp; Conditions</a
                >
              </li>
            </ul>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm sm:text-center text-gray-300 hover:text-gray-50"
          >© 2023 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights
          Reserved.
        </span>
        <div class="flex mt-4 sm:justify-center sm:mt-0">
          <a href="#" class="text-gray-300 hover:text-gray-50">
            <svg
              class="w-5 h-5"
              aria-hidden="true"
          ...
          <a href="#" class="text-gray-300 hover:text-gray-50 ms-5">
            <svg
              class="w-5 h-5"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
